<?php
    ...
    if (isset($_POST['Done'])) {
        ...
        if ($img_type==="image/png"||$img_type==="image/jpg"||$img_type==="image/jpeg") {
            ...
            $sql = "INSERT INTO Activité(Titre,description ,image) VALUES ('$title', '$content','$profile')";
            // use exec() because no results are returned
            $res = $conn->exec($sql);
        }else {
            header("Location:Add_activ.php");
...
?>
    ...
    <div class="registerBox form">
        <h2>Activité</h2>
        <form action="Add_activ.php" method="post" enctype="multipart/form-data">
            <p>Titre</p>
